...
class LineAnalyzer
  ...
  def calculate_word_frequency
    ...
    @highest_wf_count = words_hash.max_by { |word, count| count }[1]

    words_hash.each_pair { |k, v| @highest_wf_words.push(k) if v == @highest_wf_count }
...
class Solution
  ...
  def analyze_file
    File.open("test.txt", "r").each do |line, line_number|
